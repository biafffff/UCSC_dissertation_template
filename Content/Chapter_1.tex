...
In order to create a new section use the command \code{\textbackslash section\{\}}. Similarly you can use \code{\textbackslash subsection\{\}}, \code{\textbackslash subsubsection\{\}}. If you want to unnumbered a section write \code{\textbackslash section*\{\}}. 
